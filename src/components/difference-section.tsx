    ...
    <section id="difference" className="scroll-mt-16 py-20">
      ...
      >
        ...
        <div className="mx-auto mt-12 max-w-content overflow-hidden rounded-2xl border border-border/60">
          <div className="grid grid-cols-3 bg-secondary/60 text-body-sm-bold">
          ...
          {compareRows.map((row, i) => (
            <div
              key={row.label}
              className={`grid grid-cols-3 items-center text-body-sm ${
        ...
        {/* Rating callout */}
        <div className="mx-auto mt-6 flex max-w-content flex-col items-center justify-between gap-4 rounded-2xl border border-primary/20 bg-primary/5 p-6 sm:flex-row">
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-heading-md text-foreground">4.8점</p>
              <p className="text-body-sm text-muted-foreground">울단지 사용자 평점</p>
            </div>
          </div>
          <p className="text-center text-body-sm text-muted-foreground sm:text-right">
            유사 서비스 평점은 1.4~2.7점.
        ...
        <div className="mx-auto mt-10 max-w-content rounded-2xl border border-border/60 bg-card p-6">
          ...
          <ul className="mt-4 grid gap-3 sm:grid-cols-2">
            {sideEffects.map((s) => (
              <li key={s} className="flex items-start gap-2 text-body-sm text-muted-foreground">
